...
MODEL                := Lab1_2_min
MODULES              := Lab1_2_min_data.c rtGetInf.c rtGetNaN.c rt_mod_snf.c rt_nonfinite.c rt_round_snf.c 
MAKEFILE             := Lab1_2_min.mk
...
#
MODELLIB                  := Lab1_2_minlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Lab1_2_min_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);G:/Matlab/OSNMEC~1/Lab1_2_min_rtwin;G:/Matlab/OSNMEC~1
