...
MODEL                := pokus_1
MODULES              := pokus_1_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := pokus_1.mk
...
#
MODELLIB                  := pokus_1lib.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := pokus_1_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);G:/MATLAB/OSC950~1/pokus_1_rtwin;G:/MATLAB/OSC950~1
