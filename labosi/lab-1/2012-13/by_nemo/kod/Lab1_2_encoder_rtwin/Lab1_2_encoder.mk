...
MODEL                := Lab1_2_encoder
MODULES              := Lab1_2_encoder_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := Lab1_2_encoder.mk
...
#
MODELLIB                  := Lab1_2_encoderlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Lab1_2_encoder_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);G:/Matlab/OSNMEC~1/Lab1_2_encoder_rtwin;G:/Matlab/OSNMEC~1
